...
class GameType(TranslatableModel):
    class Meta:
...
class Segment(TranslatableModel):
    class Meta:
    ...
    description = PlaceholderField('segment_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['game_type'], default=1)
...
class Attribute(TranslatableModel):
    ...
    description = PlaceholderField('attribute_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['segment'], default=1)
    #
...
class ProductTypeAttribute(TranslatableModel):
...
class ManufacturingTypeAttribute(TranslatableModel):
...
class HumanResourcesTypeAttribute(TranslatableModel):
...
class Distributor(TranslatableModel):
    ...
    description = PlaceholderField('distributor_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['game_type'], default=1)
...
class DistributorAttribute(TranslatableModel):
    ...
    description = PlaceholderField('attribute_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['distributor'], default=1)
    #
    amount = models.IntegerField(default=0)
    min = models.IntegerField(default=0)
    max = models.IntegerField(default=200)
...
class DistributorSegment(models.Model):
    ...
    segment = models.ForeignKey(Segment, on_delete=models.CASCADE, null=True,
                                related_name='segment_distributors')
...
class FinanceType(TranslatableModel):
    class Meta:
    ...
    description = PlaceholderField('finance_type_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['game_type'], default=1)
...
class FinanceTypeAttribute(TranslatableModel):
    class Meta:
    ...
    description = PlaceholderField('attribute_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    order = OrderField(blank=True, for_fields=['finance_type'], default=1)
    #
    amount = models.IntegerField(default=0)
    min = models.IntegerField(default=0)
    max = models.IntegerField(default=200)
...
class Game(TranslatableModel):
    ...
    description = PlaceholderField('game_description')
    image = FilerImageField(blank=True, null=True, on_delete=models.SET_NULL)
    #
