# Generated by Django 3.0.10 on 2021-07-18 13:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('education', '0031_institutionweb_contact_us_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_web', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='received_messages', to='education.InstitutionWeb')),
            ],
            options={
