...
class ElAlgo(object):
    def __init__(self, dic):  # to_data_path, target_field
        # print("90004-000 ElAlgo", dic, '\n', '-'*50)
        try:
            super(ElAlgo, self).__init__()
        except Exception as ex:
            print("Error 90004-010 ElDataProcessing:\n"+str(ex), "\n", '-'*50)
        # print("90004-020 ElAlgo", dic, '\n', '-'*50)

class ElDataProcessing(BaseDataProcessing, BasePotentialAlgo, ElAlgo):
