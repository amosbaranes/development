...
class Case1Algo(object):
    def __init__(self, dic):  # to_data_path, target_field
        # print("90004-000 Case1Algo", dic, '\n', '-'*50)
        try:
            super(Case1Algo, self).__init__()
        except Exception as ex:
            print("Error 90004-010 Case1DataProcessing:\n"+str(ex), "\n", '-'*50)
        # print("90004-020 Case1Algo", dic, '\n', '-'*50)


class Case1DataProcessing(BaseDataProcessing, BasePotentialAlgo, Case1Algo):
